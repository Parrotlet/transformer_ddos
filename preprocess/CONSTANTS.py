...
INIT_NORM_INFO = {'highest_layer': set(),'MAX_frame_len':0.0,'MAX_tcp_flags':0.0,'MAX_tcp_window_size':0.0,
                  'MAX_tcp_len':0.0,'MAX_tcp_ack':0.0,'MAX_udp_len':0.0,'MIN_frame_len':0.0,'MIN_tcp_flags':0.0,
                  'MIN_tcp_window_size':0.0,'MIN_tcp_len':0.0,'MIN_tcp_ack':0.0,'MIN_udp_len':0.0 }
THREADLIMIT = 10
